...
public enum ZaiPeakHours: Sendable {
    private static let peakTimeZone = TimeZone(identifier: "America/New_York")!
    private static let peakStartHour = 2
    private static let peakEndHour = 6
    ...
    private static func nextPeakStart(after date: Date, calendar: Calendar) -> Date {
        ...
        return todayPeak > date ? todayPeak : calendar.date(byAdding: .day, value: 1, to: todayPeak) ?? date
    }
