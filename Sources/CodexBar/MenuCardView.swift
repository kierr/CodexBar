...
extension UsageMenuCardView.Model {
        ...
        openRouterQuotaDetail: String?) -> Metric
    {
        ...
        if input.provider == .warp || input.provider == .kilo || input.provider == .deepseek || input.provider == .chutes,
        ...
        if input.provider == .warp || input.provider == .kilo || input.provider == .deepseek || input.provider == .chutes, primary.resetsAt == nil {
